//This server has issues with images right now
...
{
  response.writeHead(errCode, {"Content-Type": "text/html;charset=utf-8"});
...
function sendData(err, stdout, stderr, response)
{
  ...
  response.write('<link rel="stylsheet" type="text/css" href="styles.css">');
...
server.listen(3001);
console.log("PHP ready to run script given on port 3001.");